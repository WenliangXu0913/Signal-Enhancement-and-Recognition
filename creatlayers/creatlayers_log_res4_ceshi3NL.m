function [layers] = creatlayers_log_res4_ceshi3NL
lgraph = layerGraph();
...
tempLayers = [
    ...
    reluLayer("Name","relu_1_14_2_1_1")
    ...
    reluLayer("Name","relu_1_14_2_1")];
lgraph = addLayers(lgraph,tempLayers);

tempLayers = [
    convolution2dLayer([1 1],32,"Name","conv_34_1","Padding","same")
    functionLayer(@(X)reshape(X,4225,32,[]),"Name","reshapeHWC_15_1")];
lgraph = addLayers(lgraph,tempLayers);

tempLayers = [
    convolution2dLayer([1 1],32,"Name","conv_16_28_1","Padding","same")
    functionLayer(@(X)pagetranspose(reshape(X,4225,32,[])),"Name","reshapeCHW_14_1")];
lgraph = addLayers(lgraph,tempLayers);

tempLayers = [
    convolution2dLayer([1 1],32,"Name","conv_17_14_1","Padding","same")
    functionLayer(@(X)reshape(X,4225,32,[]),"Name","reshapeHWC_1_14_1")];
lgraph = addLayers(lgraph,tempLayers);

tempLayers = [
    functionLayer(@(X1,X2)pagemtimes(X1,X2),"Name","matrixtimes_15_1")
    softmaxLayer("Name","softmax_14_1")];
lgraph = addLayers(lgraph,tempLayers);

tempLayers = [
    functionLayer(@(X1,X2)pagemtimes(X1,X2),"Name","matrixtimes_1_14_1")
    functionLayer(@(X)reshape(X,65,65,32,[]),"Name","inverse_reshape_14_1")
    convolution2dLayer([1 1],64,"Name","conv_18_14_1","Padding","same")];
lgraph = addLayers(lgraph,tempLayers);

tempLayers = [
    additionLayer(2,"Name","addition_1_14_1")
...
lgraph = connectLayers(lgraph,"relu_1_14_2_1","conv_34_1");
lgraph = connectLayers(lgraph,"relu_1_14_2_1","conv_16_28_1");
lgraph = connectLayers(lgraph,"relu_1_14_2_1","conv_17_14_1");
lgraph = connectLayers(lgraph,"relu_1_14_2_1","addition_1_14_1/in2");
lgraph = connectLayers(lgraph,"reshapeHWC_15_1","matrixtimes_15_1/in1");
lgraph = connectLayers(lgraph,"reshapeCHW_14_1","matrixtimes_15_1/in2");
lgraph = connectLayers(lgraph,"reshapeHWC_1_14_1","matrixtimes_1_14_1/in2");
lgraph = connectLayers(lgraph,"softmax_14_1","matrixtimes_1_14_1/in1");
lgraph = connectLayers(lgraph,"conv_18_14_1","addition_1_14_1/in1");
