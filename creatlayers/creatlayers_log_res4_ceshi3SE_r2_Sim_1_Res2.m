function [layers] = creatlayers_log_res4_ceshi3SE_r2_Sim_1_Res2
lgraph = layerGraph();
...
tempLayers = [
    ...
    fullyConnectedLayer(32,"Name","fc_24")
...
tempLayers = [
    ...
    fullyConnectedLayer(32,"Name","fc_36")
...
tempLayers = [
    ...
    fullyConnectedLayer(32,"Name","fc_48")
...
tempLayers = [
    ...
    fullyConnectedLayer(32,"Name","fc_58")
