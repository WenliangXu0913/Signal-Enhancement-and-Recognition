function [layers] = creatlayers_log_res4_ceshi3SE_r4
lgraph = layerGraph();
...
tempLayers = [
    ...
    fullyConnectedLayer(16,"Name","fc_28")
...
tempLayers = [
    ...
    fullyConnectedLayer(16,"Name","fc_30")
...
tempLayers = [
    ...
    fullyConnectedLayer(16,"Name","fc_32")
...
tempLayers = [
    ...
    fullyConnectedLayer(16,"Name","fc_34")
...
tempLayers = [
    ...
    fullyConnectedLayer(16,"Name","fc_36")
...
tempLayers = [
    ...
    fullyConnectedLayer(16,"Name","fc_38")
...
tempLayers = [
    ...
    fullyConnectedLayer(16,"Name","fc_40")
...
tempLayers = [
    ...
    fullyConnectedLayer(16,"Name","fc_42")
...
tempLayers = [
    ...
    fullyConnectedLayer(16,"Name","fc_44")
...
tempLayers = [
    ...
    fullyConnectedLayer(16,"Name","fc_46")
...
tempLayers = [
    ...
    fullyConnectedLayer(16,"Name","fc_48")
...
tempLayers = [
    ...
    fullyConnectedLayer(16,"Name","fc_50")
...
tempLayers = [
    ...
    fullyConnectedLayer(16,"Name","fc_52")
...
tempLayers = [
    ...
    fullyConnectedLayer(16,"Name","fc_54")
...
tempLayers = [
    ...
    fullyConnectedLayer(16,"Name","fc_56")
