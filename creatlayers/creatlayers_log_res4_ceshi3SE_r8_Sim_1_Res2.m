function [layers] = creatlayers_log_res4_ceshi3SE_r8_Sim_1_Res2
lgraph = layerGraph();
...
tempLayers = [
    ...
    fullyConnectedLayer(8,"Name","fc_12")
...
tempLayers = [
    ...
    fullyConnectedLayer(8,"Name","fc_24")
...
tempLayers = [
    ...
    fullyConnectedLayer(8,"Name","fc_36")
...
tempLayers = [
    ...
    fullyConnectedLayer(8,"Name","fc_48")
...
tempLayers = [
    ...
    fullyConnectedLayer(8,"Name","fc_58")
